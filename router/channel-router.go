...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/:id/agent-plan/video/tasks", permission: authz.ChannelOperate, handler: controller.ListAgentPlanVideoTasks},
	{method: http.MethodGet, path: "/:id/agent-plan/video/tasks/:task_id", permission: authz.ChannelOperate, handler: controller.GetAgentPlanVideoTask},
	{method: http.MethodDelete, path: "/:id/agent-plan/video/tasks/:task_id", permission: authz.ChannelSensitiveWrite, handler: controller.DeleteAgentPlanVideoTask},
