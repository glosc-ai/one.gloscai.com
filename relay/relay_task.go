...
func videoFetchByIDRespBodyBuilder(c *gin.Context) (respBody []byte, taskResp *dto.TaskError) {
	...
	isOpenAIVideoAPI := isOpenAIVideoAPIRequest(c)
...
func isOpenAIVideoAPIRequest(c *gin.Context) bool {
	path := c.Request.URL.Path
	return strings.HasPrefix(path, "/v1/videos/") && !strings.HasPrefix(path, "/v1/videos/generations/")
}
